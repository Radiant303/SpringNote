    ...
    switch (settings.mode) {
      ...
      case WallpaperMode.image:
        ...
        return Image.file(
          ...
          errorBuilder: (_, _, _) => DefaultGreenWallpaper(
            showLeaves: Theme.of(context).brightness != Brightness.dark,
          ),
        );
    ...
    return RepaintBoundary(
      child: CustomPaint(
        painter: _DefaultGreenWallpaperPainter(
          ...
          bgSecondary: colors.surfaceMuted,
          accent: dark ? const Color(0xFF2F6A4F) : const Color(0xFF27A270),
          isDark: dark,
...
class _DefaultGreenWallpaperPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final bottomRightGlow = RadialGradient(
      ...
      radius: 0.8,
      colors: [
        accent.withValues(alpha: isDark ? 0.08 : 0.18),
        accent.withValues(alpha: 0.0),
      ],
    );
